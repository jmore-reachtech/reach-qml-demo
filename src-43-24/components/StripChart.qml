...
Canvas{
    ...
    {
        ctx.drawWaveFormLine(yAxisPosX + valueHop, topY - scaleLineWidth, xPos(pointData.count-1) - xPos(1), calculatedScale.steps * scaleHop,  yAxisPosX + scaleLineWidth, topY - scaleLineWidth,
                                scaleBgColor, xPos(pointData.count-2), xAxisPosY + scaleLineWidth, valueHop, - (calculatedScale.steps * scaleHop)-scaleLineWidth,
                                datasetStrokeColor, datasetStrokeWidth, xPos(pointData.count-2), yPos(pointData.count-2)+0.5, xPos(pointData.count-1) , yPos(pointData.count-1)+0.5, true);
    }
