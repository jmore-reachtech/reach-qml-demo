...
Rectangle {
    ...
    Component.onCompleted: {
        var src = "import QtQuick 1.1; Timer {id: timer1; interval: 1000; running: true; repeat: true; onTriggered:{horizontal1.value = getRandomInt(horizontal1.minValue, horizontal1.maxValue-2); } }";
