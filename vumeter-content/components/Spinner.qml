...
Rectangle
{
    ...
    PathView {
        ...
        delegate: Text {verticalAlignment: Text.AlignVCenter; color: textColor; font.bold: fontText.font.bold; font.family: fontText.font.family; font.pixelSize: fontText.font.pixelSize; text: value; height: itemHeight; smooth:true }
    }
